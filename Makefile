...
OPTIMIZATION = -O3
INCLUDES = -I.
CFLAGS = -Wall -ansi $(INCLUDES) $(OPTIMIZATION) -c $(DEBUG) -fPIC
...
OBJS = BaseRTReader.o ChainWalkContext.o ChainWalkSet.o CrackEngine.o \
	fast_md5.o HashAlgorithm.o HashRoutine.o HashSet.o lm2ntlm.o fast_md4.o \
	MemoryPool.o Public.o RainbowCrack.o rcrackiThread.o RTReader.o \
...
RELEASE_DIR = rcracki_mt_0.7_beta2_src

#all: rcracki_mt strip
all: rcracki_mt

rcracki_mt: $(OBJS) RainbowCrack.so
...
RainbowCrack.o: RainbowCrack.cpp CrackEngine.h lm2ntlm.h
	$(CC) $(CFLAGS) -I$(PYTHON) -I$(BOOST_INC) RainbowCrack.cpp
...
RainbowCrack.so: RainbowCrack.o
	$(CC) $(LFLAGS) $(OBJS) $(LIBS) -shared -Wl,--export-dynamic \
