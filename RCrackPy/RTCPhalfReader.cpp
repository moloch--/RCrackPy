...
uint32 RTCPhalfReader::getChainsLeft()
{
...
int RTCPhalfReader::readChains(uint32 &numChains, RainbowChainCPhalf *pData)
{
...
void RTCPhalfReader::setChainSizeBytes( uint32 chainSizeBytes )
{
